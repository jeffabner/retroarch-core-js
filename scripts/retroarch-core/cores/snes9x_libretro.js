...
var DYNAMIC_BASE = 8117264,
    DYNAMICTOP_PTR = 2874224;
...
var ___tm_current = 2874240;
var ___tm_timezone = (stringToUTF8("GMT", 2874288, 4), 2874288);
...
var asmLibraryArg = {
    ...
    "U": _alGetSourcei,
    "Wa": _alSourcePlay,
    "Ya": _alSourceQueueBuffers,
    "Va": _alSourceStop,
    "ka": _alSourceUnqueueBuffers,
    "Ra": _alcCloseDevice,
    "ab": _alcCreateContext,
    "Sa": _alcDestroyContext,
    "la": _alcMakeContextCurrent,
    "bb": _alcOpenDevice,
    "pa": _clock_gettime,
    "Gc": _dummyErrnoCodes,
    "rf": _eglBindAPI,
    ...
    "kf": _eglCreateWindowSurface,
    "Ia": _eglDestroyContext,
    "qf": _eglDestroySurface,
    "nf": _eglGetConfigs,
    "of": _eglGetCurrentContext,
    "lf": _eglGetDisplay,
    "vf": _eglGetError,
    "uf": _eglGetProcAddress,
    "sf": _eglInitialize,
    "da": _eglMakeCurrent,
    "Ha": _eglQuerySurface,
    "pf": _eglSwapBuffers,
    "tf": _eglTerminate,
    "ib": _emscripten_exit_pointerlock,
    "xf": _emscripten_force_exit,
    "La": _emscripten_get_canvas_element_size,
    "wf": _emscripten_get_fullscreen_status,
    "K": _emscripten_get_gamepad_status,
    "de": _emscripten_glActiveTexture,
    "ce": _emscripten_glAttachShader,
    "te": _emscripten_glBeginQueryEXT,
    "be": _emscripten_glBindAttribLocation,
    "ae": _emscripten_glBindBuffer,
    "$d": _emscripten_glBindFramebuffer,
    "_d": _emscripten_glBindRenderbuffer,
    "Zd": _emscripten_glBindTexture,
    "le": _emscripten_glBindVertexArrayOES,
    ...
    "Qd": _emscripten_glClear,
    "Pd": _emscripten_glClearColor,
    "Od": _emscripten_glClearDepthf,
    ...
    "Jd": _emscripten_glCompressedTexSubImage2D,
    "Id": _emscripten_glCopyTexImage2D,
    "Hd": _emscripten_glCopyTexSubImage2D,
    "Gd": _emscripten_glCreateProgram,
    "Fd": _emscripten_glCreateShader,
    "Ed": _emscripten_glCullFace,
    "Dd": _emscripten_glDeleteBuffers,
    "Cd": _emscripten_glDeleteFramebuffers,
    "Bd": _emscripten_glDeleteProgram,
    ...
    "ge": _emscripten_glDrawArraysInstancedANGLE,
    "he": _emscripten_glDrawBuffersWEBGL,
    "qd": _emscripten_glDrawElements,
    "fe": _emscripten_glDrawElementsInstancedANGLE,
    ...
    "je": _emscripten_glGenVertexArraysOES,
    ...
    "Tc": _emscripten_glGetProgramInfoLog,
    "Uc": _emscripten_glGetProgramiv,
    "ne": _emscripten_glGetQueryObjecti64vEXT,
    "pe": _emscripten_glGetQueryObjectivEXT,
    "me": _emscripten_glGetQueryObjectui64vEXT,
    "oe": _emscripten_glGetQueryObjectuivEXT,
    "qe": _emscripten_glGetQueryivEXT,
    "Sc": _emscripten_glGetRenderbufferParameteriv,
    "Qc": _emscripten_glGetShaderInfoLog,
    "Pc": _emscripten_glGetShaderPrecisionFormat,
    "Oc": _emscripten_glGetShaderSource,
    "Rc": _emscripten_glGetShaderiv,
    "Nc": _emscripten_glGetString,
    "Mc": _emscripten_glGetTexParameterfv,
    "Lc": _emscripten_glGetTexParameteriv,
    "Ic": _emscripten_glGetUniformLocation,
    "Kc": _emscripten_glGetUniformfv,
    "Jc": _emscripten_glGetUniformiv,
    ...
    "re": _emscripten_glQueryCounterEXT,
    ...
    "Mb": _emscripten_glUniform4f,
    "Lb": _emscripten_glUniform4fv,
    "Kb": _emscripten_glUniform4i,
    "Jb": _emscripten_glUniform4iv,
    "Ib": _emscripten_glUniformMatrix2fv,
    ...
    "w": _emscripten_longjmp,
    "xe": _emscripten_memcpy_big,
    "jb": _emscripten_request_pointerlock,
    "ye": _emscripten_resize_heap,
    ...
    "Sb": _emscripten_set_keydown_callback_on_thread,
    "wb": _emscripten_set_keypress_callback_on_thread,
    "Hb": _emscripten_set_keyup_callback_on_thread,
    "bc": _emscripten_set_main_loop,
    "Ka": _emscripten_set_main_loop_timing,
    "ob": _emscripten_set_mousedown_callback_on_thread,
    "mb": _emscripten_set_mousemove_callback_on_thread,
    "nb": _emscripten_set_mouseup_callback_on_thread,
    "lb": _emscripten_set_wheel_callback_on_thread,
    "V": _emscripten_sleep,
    "Be": _environ_get,
    "Ce": _environ_sizes_get,
    "Fa": _exit,
    "M": _fd_close,
    "Ae": _fd_fdstat_get,
    "Re": _fd_read,
    ...
    "Q": _glFramebufferTexture2D,
    "Ea": _glGenBuffers,
    "X": _glGenFramebuffers,
    "Oa": _glGenRenderbuffers,
    "y": _glGenTextures,
    "S": _glGenerateMipmap,
    "wa": _glGetAttribLocation,
    "ha": _glGetError,
    "W": _glGetIntegerv,
    "af": _glGetProgramInfoLog,
    "Aa": _glGetProgramiv,
    "Ve": _glGetShaderInfoLog,
    "ua": _glGetShaderiv,
    "j": _glGetString,
